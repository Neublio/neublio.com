    ...
    <Layout>
      <section className="pt-8">
        ...
        <div className="container mx-auto px-8 mt-4 text-center lg:text-justify">
          ...
          <p className="my-2">Approved organizations may hyperlink to our Website as follows:</p>
          ...
          <h3 className="text-xl font-semibold">iFrames</h3>
          ...
          <h3 className="text-xl font-semibold">Your Privacy</h3>

          <p className="my-2">
            <a href="/privacy">Please read Privacy Policy</a>
          </p>

          <h3 className="text-xl font-semibold">Reservation of Rights</h3>
          ...
          <h3 className="text-xl font-semibold">Removal of links from our website</h3>
